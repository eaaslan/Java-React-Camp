...
public class BBJExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(BBJDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new BBJStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static BBJDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static BBJDateTimeConverter dateTimeConverter = new BBJStandardDateTimeConverter();

    public BBJExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public BBJExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new BBJMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=BBJHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,BBJExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=BBJHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
