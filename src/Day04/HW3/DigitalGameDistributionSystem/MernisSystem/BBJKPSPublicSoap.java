...
public class BBJKPSPublicSoap
{
    ...
    public BBJKPSPublicSoap(){}

    public BBJKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public BBJKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        BBJExtendedSoapSerializationEnvelope envelope= new BBJExtendedSoapSerializationEnvelope(BBJExtendedSoapSerializationEnvelope.VER11);
