...
public class ETGExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(ETGDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new ETGStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static ETGDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static ETGDateTimeConverter dateTimeConverter = new ETGStandardDateTimeConverter();

    public ETGExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public ETGExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new ETGMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=ETGHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,ETGExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=ETGHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
