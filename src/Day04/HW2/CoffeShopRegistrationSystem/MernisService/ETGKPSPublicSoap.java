...
public class ETGKPSPublicSoap
{
    ...
    public ETGKPSPublicSoap(){}

    public ETGKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public ETGKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        ETGExtendedSoapSerializationEnvelope envelope= new ETGExtendedSoapSerializationEnvelope(ETGExtendedSoapSerializationEnvelope.VER11);
